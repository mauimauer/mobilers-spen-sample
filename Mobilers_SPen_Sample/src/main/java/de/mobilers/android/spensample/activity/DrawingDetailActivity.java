 ...
 * in a {@link DrawingListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing
 * more than a {@link de.mobilers.android.spensample.fragments.DrawingDetailFragment}.
 */
public class DrawingDetailActivity extends RoboFragmentActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                //
                NavUtils.navigateUpTo(this, new Intent(this, DrawingListActivity.class));
                return true;
        }
